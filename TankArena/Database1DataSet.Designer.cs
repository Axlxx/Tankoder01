...
namespace TankArena {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string nume, string parola) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string nume {
                get {
                    return ((string)(this[this.tableTable.numeColumn]));
                }
                set {
                    this[this.tableTable.numeColumn] = value;
                }
            }
            ...
            public string parola {
                get {
                    return ((string)(this[this.tableTable.parolaColumn]));
                }
                set {
                    this[this.tableTable.parolaColumn] = value;
                }
            }
        }
...
namespace TankArena.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([nume] = @Original_nu" +
                "me) AND ([parola] = @Original_parola))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([nume], [parola]) VALUES (@nume, @parola);\r\nSELECT Id," +
                " nume, parola FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [nume] = @nume, [parola] = @parola WHERE (([Id] = @Origi" +
                "nal_Id) AND ([nume] = @Original_nume) AND ([parola] = @Original_parola));\r\nSELEC" +
                "T Id, nume, parola FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TankArena.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nume, parola FROM dbo.[Table]";
